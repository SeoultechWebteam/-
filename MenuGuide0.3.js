...
['J', 2.1, 3.1, 4.2, '오므라이스', "url()"],
['J', 2.1, 3.2, 4.1, '매운고로케', "url()"],
['J', 2.1, 3.2, 4.2, '고로케', "url(https://raw.githubusercontent.com/SeoultechWebteam/images/main/%EA%B3%A0%EB%A1%9C%EC%BC%80.jpg)"],
['J', 2.1, 3.2, 4.2, '야끼소바빵', "url()"],
['J', 2.1, 3.3, 4.1, '매운라멘', "url()"],
['J', 2.1, 3.3, 4.1, '매운나가사키짬뽕', "url()"],
...
['J', 2.1, 3.4, 4.1, '매운돈카츠나베', "url()"],
['J', 2.1, 3.4, 4.2, '가라아게', "url()"],
['J', 2.1, 3.4, 4.2, '일식화로구이', "url()"],
...
['J', 2.2, 3.4, 4.1, '매운모츠나베', "url()"],
['J', 2.2, 3.4, 4.2, '모츠나베', "url()"],
['J', 2.2, 3.4, 4.2, '스키야키', "url()"],
];
//데이터 추가 필요
